...
begin
  ...
  if ( not bBusy ) then
    ...
    begin
      //Den Updatetime aktivieren, um die ƒnderung nicht zu vergessen
        ...
        begin
         ...
         for Index:=0 to SectorSize - 1 do
            begin
              ...
              //Am Ende der Zeile den Text einf¸gen
...
begin
  ...
  //Ein Laufwerk ausgew‰hlt ?
  if (cbDrives.ItemIndex>=0) then
    begin
      //Und los geht der Spaﬂ
      with TDiskIO(cbDrives.Items.Objects[cbDrives.ItemIndex]) do
        begin
              ...
              while (u64Sector < SectorCount) and (bBusy) do
                begin
                  ...
                  if (u32Write > 0) then
                    ...
                    begin
                         //Das Image ist zuende, aber das Medium kˆnte mehr
...
begin
  ...
  if (cbDrives.ItemIndex>=0) then
    begin
      ...
      //Evtl. Existierende Datei lˆschen
    ...
    begin
      with TDiskIO(cbDrives.Items.Objects[cbDrives.ItemIndex]) do
        begin
          ...
          while (u64Sector < SectorCount) and (bBusy) do
            begin
              //Buffer flushen (wenn random gewh‰lt ist)
