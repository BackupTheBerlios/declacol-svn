...
/////////////////////////////////////////////////////////////////////////////////
//Steuerung des ServiceThreads
/////////////////////////////////////////////////////////////////////////////////
procedure svc_resume();
begin
     if (svcthread.Suspended = TRUE) then
        begin
             //Der Service war im Pausemodus und wird nun wiederbelebt
             svcthread.resume();
        end;
end;

procedure svc_suspend();
begin
     if (svcthread.Suspended = FALSE) then
        begin
             //Der Service war im Pausemodus und wird nun wiederbelebt
             svcthread.suspend();
        end;
...
////////////////////////////////////////////////////////////////////////////////
//Der Servicehandler wird in das WindowsSystem eingehängt und übernimmt die
//Steuerung des Svc_Threads.
